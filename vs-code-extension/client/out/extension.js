...
function activate(context) {
    ...
    let script = context.asAbsolutePath(path.join('..', 'xtext-dsl-language-server', 'org.iaas.xtext.ToscaYaml.ide', 'build', 'install', 'org.iaas.xtext.ToscaYaml.ide', 'bin', launcher));
